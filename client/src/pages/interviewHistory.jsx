        ...
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-emerald-50 py-10">
            ...
            <div className="w-[90vw] lg:w-[70vw] max-w-[90%] mx-auto ">
                ...
                className="mb-10 w-full flex items-start gap-4 flex-wrap">
                    <button className="m-1 p-3 rounded-full bg-white shadow hover:shadow-mf transtion ">
                        ...
                        <div >
                            ...
                            <p>
                                Trace Your Past Interviews and Performance
                            </p>
               ...
               <div className="grid gap-3">
                {interviews.map((item,index)=>(
                    ...
                    className="bg-white p-6 rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 cursor-pointer border-gray-100">

                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div>
                                <h3 className="text-lg font-semibold texxt-gray-800">{item.role}</h3>
