            ...
            {[
              ...
              >
                ...
                <div className="mt-10 text-center">
                  <p className="text-sm text-gray-400 mb-1">{item.step}</p>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                },
                {
                  ...
                  desc: "Track progress with detailed performance graphs and topic analysis."
                }
              ].map((item, index) => (
                <motion.div
                  key={index}
              ...
              {[
                {
                  ...
                  desc: "Simulates HR interviews with behavioral and situational questions."
                },
                {
                  img: techImg,
                  title: "Technical Interview Mode",
                  desc: "Focuses on coding, algorithms and system design questions."
                },
                {
                  img: confidenceImg,
                  title: "Confidence Building Mode",
                  desc: "Encourages open-ended questions to boost confidence and communication skills."
                },
                {
                  img: creditImg,
                  title: "Credit Based Custom Mode",
                  desc: "Use credits to customize question types, difficulty and interview length."
                }
              ].map((mode, index) => (
                <motion.div
                  key={index}
