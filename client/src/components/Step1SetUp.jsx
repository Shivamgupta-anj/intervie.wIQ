...
// import { FaChartLine, FaFileUpload, FaMicrophoneAlt, FaUserTie } from "react-icons/fa";
...
//                         Practice real interview scenarios powered by AI. Improve communication, technical skills, and confidence with personalized feedback. Get ready to ace your next interview!
//                     </p>
...
//                             [
//                                 {
//                                     icon : <FaUserTie className="text-green-600 text0xl"/>,
...
//                                 rounded-x1 shadow-sm cursor-pointer'>
//                                     {item.icon}
...
//                                  className="border-2 border-based border-gray-300 rounded-xl p-8 text-center cursor-pointer hover:border-green-500 hover-bg-green-50 transition">
//                                     <FaFileUpload className="text-4xl mx-auto text-green-600 mb-3"/>

//                                     <input type="file" name="" id="resumeUpload"  accept="application/pdf" className="hidden"
...
//                                             className="mt-4 bg-gray-500 text-white px-5 py-2 rounded-lg hover:bg-gray-800 transition">
